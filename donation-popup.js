/** DEV MODE - Generated at 17:14:43 */
// --- Module: modules/donation-popup.js ---
(function () {
        ...
        overlay.innerHTML = `
            <div class="donation-modal">
                ...
                <div class="donation-header">
                    ...
                    <h3>支持武理资源共享平台</h3>
                    <p class="donation-subtitle">如果这个平台曾帮到你，欢迎请我们喝杯咖啡 💰</p>
                </div>
                <div class="donation-body">
                    <p class="donation-desc">本站所有文件均免费提供，运营成本主要由毫厘本人承担。你的小小支持是项目长久运营的动力！</p>
